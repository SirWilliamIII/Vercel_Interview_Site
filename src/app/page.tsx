    ...
    <main className="flex margin-bottom min-h-screen flex-col p-24">
      <ul className="mb-8">
        ...
        <div>
          ...
          <li className="pl-[20px]">
            <p className="p-[10px]">
              <strong>Help train and onboard new support teammates</strong> This
              one seems quite obvious but having new hires up to speed quickly
              benefits everyone
            </p>
          </li>
          <li className="pl-[20px]">
            <p className="p-[10px]">
              <strong>
                Work with 3rd party partners to track down a tricky situation
                for a joint customer
              </strong>{" "}
              This is tricky and depending on the partner can be quite
              frustrating. But I enjoy connecting a 3rd party dev with our
          ...
          <li className="pl-[20px]">
            <p className="p-[10px]">
              ...
              This is where I can build those strong, long-lasting relaionships
              with customers. And being able to work closely with them, I can
              have a higher impact on them reaching their goals and remaining a
              customer. Seeing my customers succeed is where I find the most
              satisfaction.
            </p>
          </li>{" "}
        </div>
        <div>
          ...
          <li className="pl-[20px]">
            <p className="p-[10px]">
              <strong>Help resolve billing issues for customers</strong>I would
              of course facilite as much as I can but I feel that once you
              insert yourself in the customer's mind as the 'money person', the
          ...
          <li className="pl-[20px]">
            <p className="p-[10px]">
              ...
              and unfulfilling. I see its necessity but I'd rather be doing
              something in vbenefit of our customers.
            </p>
          </li>
          <li className="pl-[20px]">
            <p className="p-[10px]">
          ...
          <li className="pl-[20px]">
            <p className="p-[10px]">
              ...
              I don't have social media so I don't know how useful I would be
              for this.
            </p>
          </li>
        </div>
      ...
      <ul className="mb-8">
        <li className="text-2xl font-bold p-[25px]">
          <strong> (2) What do you want to learn or do more of at work?</strong>{" "}
        </li>
        <li className="pl-[20px]">
          <p className="p-[10px]">
            I would like to further my skills as in problem-solving, keeping up
            with the latest web frameworks and technologies. I want to hone my
      ...
      <ul className="mb-8">
        ...
        <li className="pl-[20px]">
          ...
          <p className="p-[10px]">
            I advised the client’s developers to implement a solution where they
            added a unique identifier to each sensitive HTML element containing
            PII. This would allow us to be proactive with PII remediation as
            this solution will scale infintiely without the risk of future
            exposure
          </p>
          <p className="p-[10px]">
      ...
      <ul className="mb-8">
        ...
        <li className="pl-[20px]">
          <p className="p-[10px]">
            ...
            the distance to the server is the most efficient. Also youb can
            serve more geographically relevant content to the user as the server
            is in the closer proximity{" "}
          </p>
      ...
      <ul className="mb-8">
        ...
        <li className="pl-[20px]">
          <p className="p-[10px]">
            ...
            stack overflow and other like sites to get information on the error.
            I would want to know if there had been any new updates or releases
            that could impact this issue. If still unsuccessful, I would try to
            find a tempoary work around while I consult internally to find a
            solution
          </p>
        </li>
      </ul>
      ...
      <ul className="mb-8">
        <li className="text-2xl font-bold p-[25px]">
          <strong>
            ...
            <p>
              ...
              and I just can’t figure it out. It must be a platform issue so
        ...
        <li className="pl-[20px]">
          <p className="p-[10px]">
            I'm sorry to hear that you’re experiencing difficulties with the
            platform. Let me first gather some information in order to fully
            understand the issue at hand. If this proves unsucessful, I'll be
        ...
        <li className="pl-[20px]">
          <ul className="p-[10px]">
            ...
            <li>
              ...
              object with 3 keys: 'source', 'destination', and 'permenant' set
              the value of 'source': '/blog', 'destination':
              'https://example.com' and 'permenant': true
            </li>
            <li>
      ...
      <ul className="mb-8">
        ...
        <li className="pl-[20px]">
          <p className="p-[10px]">
            ...
            a 'meta name="robots" content="noindex"' element to the head of
            their HTML file.
          </p>
        </li>
      </ul>
      ...
      <ul className="mb-8">
        ...
        <li className="pl-[20px]">
          <p className="p-[10px]">
            It is a bit awkward answering these questions within a code editor.
            I would suggest seperating the 'deploy an app' portion from these
            pure writing questions.
          </p>
        </li>
      </ul>
      <hr />
